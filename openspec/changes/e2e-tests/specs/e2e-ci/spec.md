...
- **THEN** `SIPHON_E2E_PLAYLIST_URL`, `SIPHON_E2E_VIDEO_URL`, `SIPHON_E2E_KNOWN_TRACK_URL`, and `SIPHON_E2E_MB_USER_AGENT` are available as environment variables from GitHub secrets
